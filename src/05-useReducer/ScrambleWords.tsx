...
export const ScrambleWords = () => {
  ...
  const handleGuessSubmit = (e: React.SubmitEvent) => {
    ...
    // Disparamos la acción para revisar la respuesta
    dispatch({ type: "CHECK_ANSWER" });
  };

  // Saltar palabra
  const handleSkip = () => {
    // Disparamos la acción para saltar la palabra
    dispatch({ type: "SKIP_WORD" });
  };

  // Reiniciar juego
  const handlePlayAgain = () => {
    // Disparamos la acción para jugar de nuevo, pasando los valores del estado inicial
